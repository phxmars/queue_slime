document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- ฟังก์ชันสำหรับจัดการคิว (เหมือนเดิม) ---
    const loadQueue = () => {
    ...
    // ฟังก์ชันใหม่: แสดงรายการของตกแต่งสำหรับผู้ใช้
    ...
    // ฟังก์ชันใหม่: แสดงรายการสต็อกสำหรับผู้ดูแล
    ...
    // --- จัดการ Event Listeners (เหมือนเดิม) ---
    bookingForm.addEventListener('submit', (e) => {
        ...
        bookingForm.reset();
        renderUserAddons(); // อัปเดตการแสดงผลของผู้ใช้หลังจากรีเซ็ตฟอร์ม
    });
    ...
    // Event Listener ใหม่สำหรับจัดการสต็อกสินค้า
    ...
    toggleModeBtn.addEventListener('click', () => {
        ...
        if (isUserMode) {
            ...
            if (enteredPassword === ADMIN_PASSWORD) {
                ...
                renderAddonStock(); // แสดงรายการสต็อกเมื่อเข้าโหมดผู้ดูแล
            } else {
    ...
    loadQueue();
    loadAddonStock();
    renderUserAddons(); // แสดงรายการของตกแต่งสำหรับผู้ใช้ทันทีเมื่อโหลดหน้าเว็บ
});